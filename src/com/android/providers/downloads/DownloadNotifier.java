...
public class DownloadNotifier {
    ...
    private void updateWithLocked(@NonNull Cursor cursor, @Nullable JobService jobService,
        ...
        for (int i = 0; i < clustered.size(); i++) {
            ...
            isClusterPaused = notifisPaused == cluster.size();
